...
export class GraphePage {
  ...
  ionViewDidEnter(){
    var Janvier, Fevrier, Mars, Avril, Mai, Juin, Juillet, Aout, Septembre, Octobre, Novembre, Decembre  = 0;
    ...
    var JanvierDonnes, FevrierDonnes, MarsDonnes, AvrilDonnes, MaiDonnes, JuinDonnes, JuilletDonnes, AoutDonnes, SeptembreDonnes, OctobreDonnes, NovembreDonnes, DecembreDonnes  = 0;
